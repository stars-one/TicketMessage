...
public class PermissionUtils {
     ...
     * @param permissionList 权限列表（List) 权限格式为Manifest.permission.xx
     ...
     * 请求多个权限
     * @param context Activity对象
     * @param permissions 权限列表(String数组）权限格式为Manifest.permission.xx
     * @param requestCode requestCode
     */
     ...
     * @param context Activity对象
     * @param permission 权限 格式为Manifest.permission.xx
     * @param requestCode requestCode
     */
     ...
     * 检测并申请权限
     * @param context Activity对象
     * @param permission 权限名 格式为Manifest.permission.xx
     * @param requestCode
     * @param callBack
     */
     ...
     * 判断权限是否申请成功
     */
    private static boolean isPermissionRequestSuccess(int[] grantResults) {
